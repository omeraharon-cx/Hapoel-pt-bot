...
def get_ai_summary(title, content, is_official=False, today_he=None, next_match_he=None):
    ...
    anti_fabrication_rule = (
        "🚫 איסור המצאה (חוק זהב, אכוף בקפדנות):\n"
        "• תזמון: אל תכתוב 'הערב', 'מחר', 'בקרוב', 'הסופ\"ש' אלא אם זה תואם להקשר הזמן לעיל. "
        "מילים כמו 'מחר'/'הערב' שמופיעות בכתבה מתייחסות לתאריך פרסום הכתבה — לא להיום שלך. "
        "אל תעתיק אותן. כשאין ודאות, נסח 'במשחק הקרוב' / 'במחזור הבא'.\n"
        ...
        "• בספק - השמט. עדיף תקציר קצר ומדויק על פני ארוך וכוזב. "
        "כל פרט שלא בטוח לגביו = לא נכתב.\n\n"
    )

    if is_official:
        prompt = (
            time_ctx + anti_fabrication_rule +
            ...
            "אם בכתבה מופיע ציטוט מילולי של המאמן/שחקן — אפשר לשלב אותו (במרכאות, קצר). "
            "אם אין ציטוט מילולי — אל תכתוב ציטוט. "
